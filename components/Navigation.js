        ...
        <>
            <ul className={styles.navigation}>
                ...
                <li className={styles.navigation__item}>
                    <Link href={'/'}>
                        <a className={`${styles.navigation__link}` + ((!pathname.startsWith('/map') && !pathname.startsWith('/profile')) ? ` ${styles.navigation__linkActive}` : "")} data-tip="Domů" data-background-color="#e7e7e7" data-text-color="#000000">
            ...
            <ReactTooltip place="right" effect="solid" className={styles.navigation__tooltip}/>
        </>
    );
}