    ...
    return (
        <>
            <ul className="navigation">
                ...
                <li className="navigation__item">
                    <Link href={'/'}>
                        <a data-tip="Domů" data-background-color="#e7e7e7" data-text-color="#000000" className={"navigation__link" + ((!pathname.startsWith('/map') && !pathname.startsWith('/profile')) ? " navigation__link--active" : "")}>
                ...
                <li className="navigation__item">
                    <Link href={'/map'}>
                        <a data-tip="Mapa" data-background-color="#e7e7e7" data-text-color="#000000" className={"navigation__link" + (pathname.startsWith('/map') ? " navigation__link--active": "")}>
